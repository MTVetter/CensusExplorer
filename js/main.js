...
function removeMapLayers(){
    if (map.hasLayer(counties) !== true){
        map.removeLayer(blockGroups);
        map.removeLayer(isd);
        map.removeLayer(censusPlaces);
        map.removeLayer(tracts);
        map.removeLayer(vulnerable);
        map.removeLayer(zipCodes);
    } else if (map.hasLayer(blockGroups) !== true){
        ...
        map.removeLayer(vulnerable);
        map.removeLayer(zipCodes);
    } else if (map.hasLayer(censusPlaces) !== true){
        map.removeLayer(counties);
        map.removeLayer(blockGroups);
        map.removeLayer(isd);
        map.removeLayer(tracts);
        map.removeLayer(vulnerable);
        map.removeLayer(zipCodes);
    } else if (map.hasLayer(tracts) !== true){
        map.removeLayer(counties);
        map.removeLayer(blockGroups);
        map.removeLayer(censusPlaces);
        map.removeLayer(isd);
        map.removeLayer(vulnerable);
        map.removeLayer(zipCodes);
    } else if (map.hasLayer(vulnerable) !== true){
        map.removeLayer(counties);
        map.removeLayer(blockGroups);
        map.removeLayer(censusPlaces);
        map.removeLayer(tracts);
        map.removeLayer(isd);
        map.removeLayer(zipCodes);
    } else if (map.hasLayer(zipCodes) !== true){
        map.removeLayer(counties);
        map.removeLayer(blockGroups);
        map.removeLayer(censusPlaces);
        map.removeLayer(tracts);
